...
class ABCFile: # abcfile
    ...
    def propagateStrings(self, callerInfo: str):
      ...
      for ix in range(len(self.classes)):
        ...
        if item != None:
          ...
          for ixT in range(len(item.traits)):
            ...
            else: assert False, f'@{BM.LINE()}  unhandled newItemT.data={type(newItemT.data)}'

          self.classes[ix] = newItem
      print(f'@{BM.LINE()}  type(classes[*].trait[*])={type(newItemT) if newItemT else "(None)"}')
      print(f'@{BM.LINE()}  type(classes[*].traitS[*])={type(newItemTS) if newItemTS else "(None)"}')
      print(f'@{BM.LINE()}  type(classes[*].traitM[*])={type(newItemTM) if newItemTM else "(None)"}')
      print(f'@{BM.LINE()}  type(classes[*].traitGt[*])={type(newItemTGt) if newItemTGt else "(None)"}')
      print(f'@{BM.LINE()}  type(classes[*].traitSt[*])={type(newItemTSt) if newItemTSt else "(None)"}')
      print(f'@{BM.LINE()}  type(classes[*].traitC[*])={type(newItemTC) if newItemTC else "(None)"}')
      print(f'@{BM.LINE()}  type(classes[*].traitF[*])={type(newItemTF) if newItemTF else "(None)"}')
      ...
      print(f'@{BM.LINE()}  type(instances[*].trait[*])={type(newItemT) if newItemT else "(None)"}')
      print(f'@{BM.LINE()}  type(instances[*].traitS[*])={type(newItemTS) if newItemTS else "(None)"}')
      print(f'@{BM.LINE()}  type(instances[*].traitM[*])={type(newItemTM) if newItemTM else "(None)"}')
      print(f'@{BM.LINE()}  type(instances[*].traitGt[*])={type(newItemTGt) if newItemTGt else "(None)"}')
      print(f'@{BM.LINE()}  type(instances[*].traitSt[*])={type(newItemTSt) if newItemTSt else "(None)"}')
      print(f'@{BM.LINE()}  type(instances[*].traitC[*])={type(newItemTC) if newItemTC else "(None)"}')
      print(f'@{BM.LINE()}  type(instances[*].traitF[*])={type(newItemTF) if newItemTF else "(None)"}')
      print(f'@{BM.LINE()}  type(instances[*].traitK[*])={type(newItemTK) if newItemTK else "(None)"}')
      ...
      for ix in range(len(self.method_bodies)):
        ...
        if item != None:
          ...
          for ixT in range(len(item.traits)):
            ...
            else: assert False, f'@{BM.LINE()}  unhandled newItem={type(newItem)}'
      ...
      print(f'@{BM.LINE()}  type(method_bodies[*].traitS[*])={type(newItemTS) if newItemTS else "(None)"}')
      print(f'@{BM.LINE()}  type(method_bodies[*].traitM[*])={type(newItemTM) if newItemTM else "(None)"}')
      print(f'@{BM.LINE()}  type(method_bodies[*].traitGt[*])={type(newItemTGt) if newItemTGt else "(None)"}')
      print(f'@{BM.LINE()}  type(method_bodies[*].traitSt[*])={type(newItemTSt) if newItemTSt else "(None)"}')
      print(f'@{BM.LINE()}  type(method_bodies[*].traitC[*])={type(newItemTC) if newItemTC else "(None)"}')
      print(f'@{BM.LINE()}  type(method_bodies[*].traitF[*])={type(newItemTF) if newItemTF else "(None)"}')
      print(f'@{BM.LINE()}  type(method_bodies[*].traitK[*])={type(newItemTK) if newItemTK else "(None)"}')
